...
// Picking a broad area generates subarea voting options with ids like
// "subarea_kolonaki" built from English strings. Without these entries the
// Greek UI fell back to the English name mid-vote.
optionTranslations.el.subarea_filothei = { label: "Φιλοθέη", description: "Φιλοθέη, Αθήνα" };
optionTranslations.el.subarea_chalandri = { label: "Χαλάνδρι", description: "Χαλάνδρι, Αθήνα" };
optionTranslations.el.subarea_psixiko = { label: "Ψυχικό", description: "Ψυχικό, Αθήνα" };
optionTranslations.el.subarea_kifisia = { label: "Κηφισιά", description: "Κηφισιά, Αθήνα" };
optionTranslations.el.subarea_kefalari = { label: "Κεφαλάρι", description: "Κεφαλάρι, Αθήνα" };
optionTranslations.el.subarea_syntagma = { label: "Σύνταγμα", description: "Σύνταγμα, Αθήνα" };
optionTranslations.el.subarea_monastiraki = { label: "Μοναστηράκι", description: "Μοναστηράκι, Αθήνα" };
optionTranslations.el.subarea_psyrri = { label: "Ψυρρή", description: "Ψυρρή, Αθήνα" };
optionTranslations.el.subarea_exarcheia = { label: "Εξάρχεια", description: "Εξάρχεια, Αθήνα" };
optionTranslations.el.subarea_kolonaki = { label: "Κολωνάκι", description: "Κολωνάκι, Αθήνα" };
optionTranslations.el.subarea_glyfada = { label: "Γλυφάδα", description: "Γλυφάδα, Αθήνα" };
optionTranslations.el.subarea_vouliagmeni = { label: "Βουλιαγμένη", description: "Βουλιαγμένη, Αθήνα" };
optionTranslations.el.subarea_alimos = { label: "Άλιμος", description: "Άλιμος, Αθήνα" };
optionTranslations.el.subarea_flisvos = { label: "Φλοίσβος", description: "Φλοίσβος, Αθήνα" };
optionTranslations.el.subarea_voula = { label: "Βούλα", description: "Βούλα, Αθήνα" };
...
function placesAreaOptions(sel) {
  return `<option value="">${escapeHtml(t("allOfAthens"))}</option>` +
    (state.areas || []).map((a) => `<option value="${escapeHtml(a.id)}" ${a.id === sel ? "selected" : ""}>${escapeHtml(optionLabel("area", a))}</option>`).join("");
}
function placesCategoryOptions() {
  return `<option value="">${escapeHtml(t("anyCategory"))}</option>` +
    (state.types || []).map((tp) => `<option value="${escapeHtml(tp.id)}">${escapeHtml(optionLabel("type", tp))}</option>`).join("");
}
